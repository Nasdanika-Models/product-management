...
public class ProductmanagementSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case ProductmanagementPackage.LIFECYCLE_STATUS_PERIOD: {
			...
			case ProductmanagementPackage.CAPABILITY_VERSION: {
			...
			case ProductmanagementPackage.CAPABILITY_PROVIDER_VERSION: {
			...
			case ProductmanagementPackage.OFFERING: {
			...
			case ProductmanagementPackage.WORK_PACKAGE: {
			...
			case ProductmanagementPackage.JIRA_WORK_PACKAGE: {
			...
			case ProductmanagementPackage.PROPOSAL: {
