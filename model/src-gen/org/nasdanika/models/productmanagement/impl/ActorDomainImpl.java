 ...
 * </p>
 * <ul>
 *   <li>{@link org.nasdanika.models.productmanagement.impl.ActorDomainImpl#getActors <em>Actors</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActorDomainImpl extends NamedElementImpl implements ActorDomain {
	...
	protected EClass eStaticClass() {
		return ProductmanagementPackage.Literals.ACTOR_DOMAIN;
	}
	...
	public EList<AbstractActor> getActors() {
		return (EList<AbstractActor>)eDynamicGet(ProductmanagementPackage.ACTOR_DOMAIN__ACTORS, ProductmanagementPackage.Literals.ACTOR_DOMAIN__ACTORS, true, true);
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case ProductmanagementPackage.ACTOR_DOMAIN__ACTORS:
