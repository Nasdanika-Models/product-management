...
public class PersonaDomainNodeProcessor extends NamedElementNodeProcessor<PersonaDomain> implements PersonaDomainMixIn<PersonaDomain> { 

	public PersonaDomainNodeProcessor(
