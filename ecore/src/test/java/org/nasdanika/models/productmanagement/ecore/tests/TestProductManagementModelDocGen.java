package org.nasdanika.models.productmanagement.ecore.tests;
...
import org.nasdanika.models.productmanagement.ecore.EcoreGenProductManagementProcessorsFactory;
 ...
 *
 */
public class TestProductManagementModelDocGen {
	
	@Test
	public void testGenerateProductManagementModelDoc() throws IOException, DiagnosticException {
		ProgressMonitor progressMonitor = new NullProgressMonitor(); // new PrintStreamProgressMonitor();
		MutableContext context = Context.EMPTY_CONTEXT.fork();
		Consumer<Diagnostic> diagnosticConsumer = d -> d.dump(System.out, 0);
		List<Function<URI,Action>> actionProviders = new ArrayList<>();		
		EcoreGenProductManagementProcessorsFactory ecoreGenProcessorFactory = new EcoreGenProductManagementProcessorsFactory(context);		
		...
		File output = new File(actionModelsDir, "product-management.xmi");
		...
		EcoreHtmlAppGenerator eCoreHtmlAppGenerator = new EcoreHtmlAppGenerator(
				ProductManagementPackage.eINSTANCE, 
				packageURIMap, 
		...
		String siteMapDomain = "https://product-management.models.nasdanika.org";		
